...
function renderDriveAnalytics(entries, yr, panel) {
  ...
  panel.innerHTML =
    '<style>' +
      ...
      '@media(max-width:430px){.analytics-tabs{grid-template-columns:repeat(2,minmax(0,1fr))}.analytics-tabs button:first-child{grid-column:1 / -1}.dash-hero-grid{grid-template-columns:repeat(2,minmax(0,1fr));gap:8px}.dash-hero-card{min-height:112px;padding:11px;border-radius:14px}.dash-hero-card:nth-child(3){grid-column:1 / -1}.dash-hero-visual{right:7px;top:7px;transform:scale(.78);transform-origin:top right}.dash-hero-head{max-width:74%}.dash-hero-head span:first-child{font-size:9px}.dash-hero-head span:last-child{font-size:8px}.dash-hero-value{left:11px;right:46px;bottom:12px;font-size:18px}.dash-hero-scale{right:9px;bottom:10px;width:28px;height:25px;min-width:28px}.dash-mini-grid{grid-template-columns:repeat(2,minmax(0,1fr));gap:8px}.dash-metric-card{min-height:82px;padding:10px 9px}.dash-metric-icon{font-size:15px;margin-bottom:5px}.dash-metric-card b{font-size:14px}.dash-metric-card span{font-size:9px}.dash-metric-card small{font-size:8px}.dash-bars{gap:5px}.dash-top-row{grid-template-columns:24px minmax(0,1fr)}.dash-top-row strong{grid-column:2;text-align:left}.overview-year-card{grid-template-columns:1fr;gap:9px}.overview-year-money{text-align:left}.journal-trip-card{padding:11px;border-radius:16px}.journal-trip-main{grid-template-columns:1fr;gap:8px}.journal-trip-money{text-align:left;min-width:0;display:flex;align-items:baseline;gap:8px}.journal-trip-title{font-size:13px}.journal-trip-route{-webkit-line-clamp:1}.journal-trip-strip span{font-size:9px;padding:6px 7px}.journal-card-inner{padding:12px}.journal-summary{grid-template-columns:1fr}.journal-stat{border-right:0;border-bottom:1px solid rgba(57,217,138,.18)}.journal-stat:last-child{border-bottom:0}.journal-delete{width:42px;height:42px}.route-map-dialog{padding:13px}.route-map-head{display:block}.route-map-sum{margin-top:6px}.route-map-large{min-height:280px}.route-map-large iframe{height:280px}.route-map-state{min-height:170px}}' +
    '</style>' +
