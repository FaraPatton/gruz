...
function buildManualKmHtml(trip) {
  return '<div class="route-map-manual-km">' +
    ...
    '<div>' +
      ...
      '<label class="manual-save-check" title="Сохранить километраж" aria-label="Сохранить километраж">' +
        '<input id="manualRouteKmSave" type="checkbox" onchange="saveManualRouteKmEncoded(&quot;' + routeMapId(trip.id) + '&quot;)">' +
        '<div class="manual-save-checkmark"></div>' +
      '</label>' +
    '</div>' +
...
async function saveManualRouteKm(tripId) {
  ...
  const trigger = check && check.closest('.manual-save-check');
...
function renderDriveAnalytics(entries, yr, panel) {
  ...
  panel.innerHTML =
    '<style>' +
      ...
      '.journal-trip-list{display:grid;gap:10px}.journal-trip-card{position:relative;overflow:hidden;border:1px solid rgba(79,124,255,.34);border-radius:19px;padding:12px;background:linear-gradient(145deg,rgba(35,25,54,.98),rgba(15,12,24,.98));box-shadow:0 16px 34px rgba(0,0,0,.24),inset 0 1px 0 rgba(255,255,255,.05);cursor:pointer;transition:transform .22s ease,border-color .22s ease,box-shadow .22s ease,background .22s ease}.journal-trip-card:before{content:"";position:absolute;inset:-1px;background:radial-gradient(circle at 88% 12%,rgba(79,124,255,.24),transparent 30%),radial-gradient(circle at 12% 105%,rgba(57,217,138,.18),transparent 30%);opacity:.78;pointer-events:none;transition:opacity .25s ease,transform .32s ease}.journal-trip-card:hover,.journal-trip-card.is-open{transform:translateY(-2px);border-color:rgba(79,124,255,.62);box-shadow:0 22px 44px rgba(0,0,0,.3),0 0 24px rgba(79,124,255,.12),inset 0 1px 0 rgba(255,255,255,.06)}.journal-trip-card:hover:before,.journal-trip-card.is-open:before{opacity:1;transform:scale(1.04)}.journal-trip-card:focus-visible{outline:3px solid rgba(79,124,255,.32);outline-offset:3px}.journal-trip-main,.journal-trip-strip,.journal-trip-expand{position:relative;z-index:1}.journal-trip-main{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:12px;align-items:start}.journal-trip-kicker{color:var(--ana);font-family:monospace;font-size:10px;letter-spacing:0;font-weight:800;text-transform:uppercase}.journal-trip-title{margin-top:5px;color:var(--ana-text);font-size:14px;font-weight:820;line-height:1.2;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.journal-trip-route{margin-top:5px;color:var(--ana-muted);font-size:11px;line-height:1.35;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden}.journal-trip-money{text-align:right;min-width:96px}.journal-trip-money b{display:block;color:#fff;font-size:16px;line-height:1.1;white-space:nowrap}.journal-trip-money span{display:block;margin-top:4px;color:var(--ana-muted);font-size:10px}.journal-trip-strip{display:flex;gap:6px;flex-wrap:wrap;margin-top:11px}.journal-trip-strip span{border:1px solid rgba(79,124,255,.22);border-radius:999px;background:rgba(79,124,255,.08);color:var(--ana-muted);font-size:10px;line-height:1;padding:6px 8px;white-space:nowrap}.journal-trip-strip b{color:var(--ana-text);font-weight:820}.journal-trip-strip span:first-child{border-color:rgba(57,217,138,.28);background:rgba(57,217,138,.08);color:rgba(224,255,241,.78)}.journal-trip-expand{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:10px;max-height:0;opacity:0;transform:translateY(-7px);overflow:hidden;transition:max-height .42s ease,opacity .26s ease,transform .32s ease,margin-top .32s ease}.journal-trip-card:hover .journal-trip-expand,.journal-trip-card.is-open .journal-trip-expand{max-height:210px;opacity:1;transform:translateY(0);margin-top:12px}.journal-map-btn-wrapper{--btn-color:#f5101b;--text-color:#fff;--land-color:#ffdd9f;--veg-color:#36ad5aa9;--water-color:#b3e3ff;--transition-dur:.3s;grid-column:1/-1;position:relative;display:flex;width:max-content;max-width:100%;font-size:13px;font-family:Inter,system-ui,sans-serif;user-select:none;overflow:visible;border-radius:50ch;filter:drop-shadow(0 14px 22px rgba(0,0,0,.2));transition:transform var(--transition-dur) ease}.journal-map-btn{cursor:pointer;padding:1em 1.5em 1em 3.5em;border-radius:50ch;background-color:var(--btn-color);font-weight:700;color:var(--text-color);white-space:nowrap;transition:color var(--transition-dur) ease-in-out,background-color var(--transition-dur) ease-in-out}.journal-pinpoint{pointer-events:none;position:absolute;height:60%;aspect-ratio:1;top:20%;left:.75em;border-radius:50%;background-color:var(--text-color);transform:rotateZ(45deg);mask-image:radial-gradient(circle at center,#0000 0%,#0000 32%,#fff 36%);filter:blur(.25px);transition:background-color var(--transition-dur) ease-in-out,transform var(--transition-dur) ease-in-out,border-radius calc(var(--transition-dur) + .1s) ease;z-index:1}.journal-map-container{pointer-events:none;position:absolute;left:0;top:84px;perspective:120px;transform:perspective(120px) rotateX(35deg) scaleX(0);transform-origin:3em .5em;transition:transform var(--transition-dur) ease-in-out,opacity var(--transition-dur) ease-in-out;opacity:0;z-index:0}.journal-map-fold{position:absolute;bottom:100px;width:100px;height:170px;background-color:var(--water-color);background-image:linear-gradient(to bottom,#fff2,30%,#0000);transform-origin:left bottom;mask-image:linear-gradient(to top,#fff,97%,#0000);overflow:hidden}.journal-map-fold:after{content:"";top:-40px;left:12px;width:100%;height:200%;background-color:var(--land-color);position:absolute;filter:url(#journalLand);box-shadow:inset 0 0 48px 24px var(--veg-color);z-index:0}.journal-map-fold:before{content:"";position:absolute;top:0;left:0;width:100%;height:100%;box-shadow:inset 0 10px 16px 3px #0004;z-index:1}.journal-fold-1{left:-50px;transform:rotateY(10deg) translateZ(30px)}.journal-fold-2{left:50px;transform:rotateY(-10deg) translateZ(10px)}.journal-fold-3{left:-141px;transform:rotateY(-15deg) translateZ(-1px)}.journal-fold-4{left:139px;transform:rotateY(15deg) translateZ(31px)}.journal-map-btn-wrapper:hover{transform:scale(1.06)}.journal-map-btn-wrapper:hover .journal-map-btn{background-color:var(--text-color);color:#00000025}.journal-map-btn-wrapper:hover .journal-pinpoint{background-color:var(--btn-color);border-radius:50% 50% 0 50%;transform:rotateZ(45deg) translate(-.3em,-.3em)}.journal-map-btn-wrapper:hover .journal-map-container{transform:perspective(100px) rotateX(35deg) scaleX(.78);opacity:1}.journal-map-btn-wrapper:active{transform:scale(1.02) translateY(.2em)}.journal-map-btn-wrapper:active .journal-pinpoint{transform:rotateZ(45deg) translate(0,0);transition-duration:calc(var(--transition-dur) * .5)}.journal-map-btn-wrapper:active .journal-map-container{transform:perspective(95px) rotateX(35deg) scaleX(.78);transition-duration:calc(var(--transition-dur) * .5)}.journal-trip-more{min-width:0;color:rgba(248,251,255,.6);font-size:10px;font-family:monospace;letter-spacing:0;line-height:1.45}.journal-trip-more b{display:block;color:var(--ana);font-family:inherit;font-size:11px;margin-bottom:2px}.journal-trip-delete{align-self:end}' +
      ...
      '@media(max-width:430px){.analytics-tabs{grid-template-columns:repeat(2,minmax(0,1fr))}.analytics-tabs button:first-child{grid-column:1 / -1}.overview-year-card{grid-template-columns:1fr;gap:9px}.overview-year-money{text-align:left}.journal-trip-card{padding:11px;border-radius:16px}.journal-trip-main{grid-template-columns:1fr;gap:8px}.journal-trip-money{text-align:left;min-width:0;display:flex;align-items:baseline;gap:8px}.journal-trip-title{font-size:13px}.journal-trip-route{-webkit-line-clamp:1}.journal-trip-strip span{font-size:9px;padding:6px 7px}.journal-map-btn-wrapper{font-size:12px}.journal-map-container{top:78px}.journal-map-fold{width:86px;height:148px}.journal-fold-1{left:-43px}.journal-fold-2{left:43px}.journal-fold-3{left:-121px}.journal-fold-4{left:120px}.journal-card-inner{padding:12px}.journal-summary{grid-template-columns:1fr}.journal-stat{border-right:0;border-bottom:1px solid rgba(57,217,138,.18)}.journal-stat:last-child{border-bottom:0}.journal-delete{width:42px;height:42px}.route-map-dialog{padding:13px}.route-map-head{display:block}.route-map-sum{margin-top:6px}.route-map-large{min-height:280px}.route-map-large iframe{height:280px}.route-map-state{min-height:170px}}' +
    '</style>' +
      ...
      sorted.map(trip => {
        ...
        return '<div class="journal-trip-card" role="button" tabindex="0" title="Раскрыть и открыть маршрут" onclick="toggleJournalCardAndMap(this,&quot;' + encodedId + '&quot;)" onkeydown="' + keyHandler + '">' +
          ...
          '<div class="journal-trip-expand">' +
            '<div class="journal-map-btn-wrapper" aria-hidden="true">' +
              '<svg height="0" width="0" focusable="false" aria-hidden="true"><filter id="journalLand"><feTurbulence result="turb" numOctaves="7" baseFrequency="0.006" type="fractalNoise"></feTurbulence><feDisplacementMap yChannelSelector="G" xChannelSelector="R" scale="700" in="SourceGraphic" in2="turb"></feDisplacementMap></filter></svg>' +
              '<div class="journal-map-btn">Открыть карту</div>' +
              '<div class="journal-pinpoint"></div>' +
              '<div class="journal-map-container">' +
                '<div class="journal-map-fold journal-fold-1"></div>' +
                '<div class="journal-map-fold journal-fold-2"></div>' +
                '<div class="journal-map-fold journal-fold-3"></div>' +
                '<div class="journal-map-fold journal-fold-4"></div>' +
              '</div>' +
            '</div>' +
