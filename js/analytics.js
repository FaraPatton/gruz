...
function dashboardHeroCard(label, value, hint, trend, tone) {
  return '<div class="dash-hero-card ' + aEsc(tone || '') + '">' +
    '<div class="dash-hero-weather" aria-hidden="true">' +
      '<div class="dash-hero-cloud front"><span class="dash-cloud-left-front"></span><span class="dash-cloud-right-front"></span></div>' +
      '<span class="dash-hero-sun shine"></span><span class="dash-hero-sun"></span>' +
      '<div class="dash-hero-cloud back"><span class="dash-cloud-left-back"></span><span class="dash-cloud-right-back"></span></div>' +
    '</div>' +
