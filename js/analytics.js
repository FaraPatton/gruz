...
function buildManualKmHtml(trip) {
  return '<div class="route-map-manual-km">' +
    ...
    '<div>' +
      ...
      '<label class="holo-save-check" title="Сохранить километраж">' +
        '<input class="holo-checkbox-input" id="manualRouteKmSave" type="checkbox" onchange="saveManualRouteKmEncoded(&quot;' + routeMapId(trip.id) + '&quot;)">' +
        '<span class="holo-checkbox">' +
          '<span class="holo-box">' +
            '<span class="holo-inner"></span>' +
            '<span class="scan-effect"></span>' +
            '<span class="holo-particles">' +
              '<span class="holo-particle"></span><span class="holo-particle"></span><span class="holo-particle"></span>' +
              '<span class="holo-particle"></span><span class="holo-particle"></span><span class="holo-particle"></span>' +
            '</span>' +
            '<span class="activation-rings"><span class="activation-ring"></span><span class="activation-ring"></span><span class="activation-ring"></span></span>' +
          '</span>' +
          '<span class="corner-accent"></span><span class="corner-accent"></span><span class="corner-accent"></span><span class="corner-accent"></span>' +
          '<span class="holo-glow"></span>' +
        '</span>' +
        '<span class="holo-save-text">Сохранить</span>' +
      '</label>' +
    '</div>' +
...
function renderDriveAnalytics(entries, yr, panel) {
  ...
  panel.innerHTML =
    '<style>' +
      ...
      '.route-map-manual-km{margin-top:12px;border:1px solid rgba(137,104,190,.28);border-radius:10px;background:rgba(255,255,255,.035);padding:10px}.route-map-manual-km>label{display:block;color:var(--ana-muted);font-size:10px;font-family:monospace;letter-spacing:0;margin-bottom:6px}.route-map-manual-km>div{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:10px;align-items:center}.route-map-manual-km input{min-width:0;border:1px solid rgba(57,217,138,.24);border-radius:8px;background:rgba(255,255,255,.06);color:var(--ana-text);padding:10px 11px;font-size:14px;outline:0}.route-map-manual-km input:focus{border-color:rgba(57,217,138,.62);box-shadow:0 0 0 3px rgba(57,217,138,.1)}.holo-save-check{position:relative;display:inline-flex!important;align-items:center;gap:9px;margin:0!important;min-height:42px;padding:7px 12px;border-radius:10px;background:linear-gradient(135deg,rgba(57,217,138,.08),rgba(137,104,190,.08));border:1px solid rgba(57,217,138,.32);cursor:pointer;user-select:none;overflow:hidden;transition:transform .16s ease,border-color .18s ease,box-shadow .18s ease}.holo-save-check:hover{transform:translateY(-1px);border-color:rgba(57,217,138,.62);box-shadow:0 12px 24px rgba(57,217,138,.12)}.holo-checkbox-input{position:absolute!important;opacity:0!important;pointer-events:none!important}.holo-checkbox{position:relative;width:28px;height:28px;display:block;flex:0 0 28px}.holo-box{position:absolute;inset:0;border:2px solid rgba(57,217,138,.72);border-radius:8px;background:rgba(8,11,18,.78);box-shadow:inset 0 0 12px rgba(57,217,138,.12),0 0 12px rgba(57,217,138,.08);overflow:hidden;transition:.22s ease}.holo-inner{position:absolute;inset:7px;border-radius:4px;background:rgba(57,217,138,.1);opacity:.45;transition:.2s ease}.scan-effect{position:absolute;left:-30%;right:-30%;height:2px;top:-5px;background:linear-gradient(90deg,transparent,var(--ana),transparent);opacity:0;filter:blur(.2px)}.holo-particles,.activation-rings{position:absolute;inset:0;pointer-events:none}.holo-particle{position:absolute;width:3px;height:3px;border-radius:50%;background:var(--ana);opacity:0}.holo-particle:nth-child(1){left:4px;top:4px}.holo-particle:nth-child(2){right:4px;top:5px}.holo-particle:nth-child(3){left:7px;bottom:4px}.holo-particle:nth-child(4){right:7px;bottom:4px}.holo-particle:nth-child(5){left:12px;top:2px}.holo-particle:nth-child(6){right:12px;bottom:2px}.activation-ring{position:absolute;inset:2px;border:1px solid rgba(57,217,138,.45);border-radius:8px;opacity:0}.corner-accent{position:absolute;width:7px;height:7px;border-color:var(--ana);opacity:.65}.corner-accent:nth-of-type(1){left:-1px;top:-1px;border-top:1px solid;border-left:1px solid}.corner-accent:nth-of-type(2){right:-1px;top:-1px;border-top:1px solid;border-right:1px solid}.corner-accent:nth-of-type(3){left:-1px;bottom:-1px;border-bottom:1px solid;border-left:1px solid}.corner-accent:nth-of-type(4){right:-1px;bottom:-1px;border-bottom:1px solid;border-right:1px solid}.holo-glow{position:absolute;inset:-8px;border-radius:12px;background:radial-gradient(circle,rgba(57,217,138,.28),transparent 68%);opacity:0;transition:.2s ease}.holo-save-text{position:relative;z-index:1;color:var(--ana-text);font-size:12px;font-weight:850;white-space:nowrap}.holo-checkbox-input:checked + .holo-checkbox .holo-box{background:linear-gradient(180deg,var(--ana),var(--ana2));border-color:transparent;box-shadow:0 0 18px rgba(57,217,138,.45)}.holo-checkbox-input:checked + .holo-checkbox .holo-inner{background:#07140d;opacity:1;clip-path:polygon(14% 48%,38% 72%,86% 18%,96% 28%,39% 88%,4% 57%)}.holo-checkbox-input:checked + .holo-checkbox .scan-effect{animation:holoScan .72s ease-out}.holo-checkbox-input:checked + .holo-checkbox .holo-particle{animation:holoParticle .55s ease-out}.holo-checkbox-input:checked + .holo-checkbox .activation-ring{animation:holoRing .7s ease-out}.holo-checkbox-input:checked + .holo-checkbox .holo-glow{opacity:1}.route-map-manual-km p{margin:7px 0 0;color:rgba(248,251,255,.55);font-size:10px;line-height:1.35}@keyframes holoScan{0%{top:-5px;opacity:0}25%{opacity:1}100%{top:30px;opacity:0}}@keyframes holoParticle{0%{transform:scale(.3);opacity:0}35%{opacity:1}100%{transform:scale(1.8);opacity:0}}@keyframes holoRing{0%{transform:scale(.72);opacity:0}35%{opacity:.8}100%{transform:scale(1.45);opacity:0}}' +
